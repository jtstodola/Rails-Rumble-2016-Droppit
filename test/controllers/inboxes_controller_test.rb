...
class InboxesControllerTest < ActionController::TestCase
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post :create, inbox: { name: @inbox.name, remote_folder: @inbox.remote_folder, service: @inbox.service }
    end
  ...
  test "should update inbox" do
    patch :update, id: @inbox, inbox: { name: @inbox.name, remote_folder: @inbox.remote_folder, service: @inbox.service }
    assert_redirected_to inbox_path(assigns(:inbox))
  end
